...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "In Islam, seeking knowledge is not just encouraged—it's obligatory. The Prophet Muhammad ﷺ said, 'Seeking knowledge is mandatory for every Muslim.' Discover why education holds such a central place in our faith.",
  ...
  },
  {
    ...
    slug: "balancing-studies-and-deen",
    excerpt:
      "As university students, finding the balance between academic responsibilities and religious duties can be challenging. Here are practical tips for maintaining your Islamic practices while excelling in your studies.",
  ...
  },
  {
    ...
    slug: "etiquettes-of-seeking-knowledge",
    excerpt:
      "The scholars of Islam have outlined important etiquettes for students of knowledge. Learn about these essential principles that can transform your educational journey.",
  ...
  },
  {
    ...
    slug: "muslim-students-in-modern-society",
    excerpt:
      "As Muslim students in the contemporary world, we have unique opportunities and challenges. Explore how we can maintain our Islamic identity while positively contributing to society.",
